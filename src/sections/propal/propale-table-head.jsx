...
function UserTableHead(props) {
    ...
    return (
        <TableHead>
            <TableRow>
                <TableCell sortDirection={orderBy === 'propaleName' ? order : false}>
                    <TableSortLabel
                ...
                <TableCell sortDirection={orderBy === 'budget_no_vat' ? order : false}>
                    <TableSortLabel
                ...
                <TableCell sortDirection={orderBy === 'estimated_value' ? order : false}>
                    <TableSortLabel
